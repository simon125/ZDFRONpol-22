...
/* podejście 1 */
const joinedPhrases1 = phrases.join(" ");

/* podejście 2 */
let joinedPhrases2 = "";

phrases.forEach((phrase) => {
  joinedPhrases2 += `${phrase} `;
});

/* podejście 3 */
const joinedPhrases3 = phrases.reduce((acc, phrase) => {
  acc += `${phrase} `;
...
const htmlList = `
    <ul>
        <li>Pouczyć się GITa</li>
        <li>Pouczyć się HTMLa</li>
        <li>Pouczyć się CSSa</li>
        <li>Pouczyć się JSa</li>
    </ul>
`;
